			...
			<div>
				<nav class="d-nav">
					<ul class="d-nav d-nav__list">
						...
						<li class="d-nav__item d-nav__item--active"><a href="/pollen-steet/login">Login</a></li>
					</ul>
				</nav>
			</div>
		...
		<section id="login" class="section">
			<div class="login">
				...
				<div class="login__credit">
					<h3>Credit</h3>
					<div>
						<img src="/pollen-steet/assets/img/honeycomb.svg" alt="" />
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
						<a href="#">
							<button class="secondary-button">
					...
					<div>
						<img src="/pollen-steet/assets/img/p2p.svg" alt="" />
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
						<a href="#">
							<button class="secondary-button">
								<span>Go to website</span><hr />
			...
			<div class="footer__container">
				...
				<nav>
					<ul class="footer__footer-nav">
						...
						<li class="footer__footer-nav--active"><a href="/pollen-steet/login">Login</a></li>
			...
			<div class="burger-menu__container">
				...
				<nav>
					...
					<ul>
						...
						<li><a href="/pollen-steet/news">News</a></li>
						<li><a href="/pollen-steet/contact">Contact</a></li>
						<li class="nav-active"><a href="/pollen-steet/login">Login</a></li>
					</ul>
				</nav>
			</div>
		</div>
