	...
	<body>
			...
			<div>
				<nav class="d-nav">
					<ul class="d-nav d-nav__list">
						...
						<li class="d-nav__item d-nav__item--active"><a href="/pollen-street/login">Login</a></li>
					</ul>
				</nav>
			</div>
		...
		<section id="login" class="section">
			<div class="login">
				...
				<div class="login__private-equity">
					...
					<div>
						...
						<form class="form">
							<div data-validate="Username is required">
								<p>Username</p>
								<input type="text" name="username" placeholder="Enter username" class="form__field">
							</div>
							<div data-validate = "Password is required">
								<p>Password</p>
								<input type="password" name="pass" placeholder="Enter password" class="form__field">
							</div>

							<div class="form__footer">
								<div>
									<input id="ckb1" type="checkbox" name="remember-me">
									<label for="ckb1" class="disclaimer">
										Remember me
									</label>
								</div>
								<div>
					...
					<div>
						...
						<form class="form">
							...
							<div class="form__footer">
								<div>
									<input id="ckb2" type="checkbox" name="remember-me">
									<label for="ckb2" class="disclaimer">
										Remember me
									</label>
								</div>
								<div>
				...
				<div class="login__credit">
					<h3>Credit</h3>
					<div>
						<img src="/pollen-street/assets/img/honeycomb.svg" alt="" />
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
						<a href="#">
							<button class="secondary-button">
								<span>Go to website</span><hr />
							</button>
						</a>
					</div>
					<div>
						<img src="/pollen-street/assets/img/p2p.svg" alt="" />
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</p>
						<a href="#">
							<button class="secondary-button">
								<span>Go to website</span><hr />
			...
			<div class="footer__container">
				...
				<nav>
					<ul class="footer__footer-nav">
						...
						<li class="footer__footer-nav--active"><a href="/pollen-street/login">Login</a></li>
			...
			<div class="burger-menu__container">
				...
				<nav>
					...
					<ul>
						...
						<li><a href="/pollen-street/news">News</a></li>
						<li><a href="/pollen-street/contact">Contact</a></li>
						<li class="nav-active"><a href="/pollen-street/login">Login</a></li>
					</ul>
				</nav>
			</div>
		</div>
