			...
			<div>
				<nav class="d-nav">
					<ul class="d-nav d-nav__list">
						...
						<li class="d-nav__item d-nav__item--active"><a href="/pollen-steet/news">News</a></li>
			...
			<div class="footer__container">
				...
				<nav>
					<ul class="footer__footer-nav">
						...
						<li class="footer__footer-nav--active"><a href="/pollen-steet/news">News</a></li>
			...
			<div class="burger-menu__container">
				...
				<nav>
					...
					<ul>
						...
						<li><a href="/pollen-steet/people">People</a></li>
						<li><a href="/pollen-steet/portfolio">Portfolio</a></li>
						<li class="nav-active"><a href="/pollen-steet/news">News</a></li>
						<li><a href="/pollen-steet/contact">Contact</a></li>
						<li><a href="/pollen-steet/login">Login</a></li>
					</ul>
				</nav>
