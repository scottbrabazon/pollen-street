...
<html class="nojs" lang="en">
	...
	<body>
		...
		<!-- Intro -->
		<section id="news-intro" class="news-intro">
			<div class="intro">
		...
		<section id="news" class="section">
			<div class="news">
				...
				<div class="news__body">
					<div class="dropdown">
						<div class="title"><h1 class="x-light-grey accordion-trigger">PSC Fund III closes. £50m oversubscribed 53% already invested</h1>
						<p class="news__date">Monday 23rd July 2018</p>
							<ul class="contents" >
								<li>
									<p>Lorem ipsum dolor sit amet, altera fastidii voluptua sed cu, cu hinc adolescens sea, ei mel delicata molestiae constituam. Quot exerci meliore vel ex, eam affert propriae cu. Sea choro splendide similique ad.</p>
									<p>Lorem ipsum dolor sit amet, altera fastidii voluptua sed cu, cu hinc adolescens sea, ei mel delicata molestiae constituam. Quot exerci meliore vel ex, eam affert propriae cu. Sea choro splendide similique ad.</p>
									<a href="post.php">
					...
					<div class="dropdown">
						<div class="title"><h1 class="x-light-grey accordion-trigger">PSC proposes to acquire top 40 UK insurance broker Miles Smith</h1>
							<p class="news__date">Monday 23rd July 2018</p>
							<ul class="contents" >
								<li>
									<p>Lorem ipsum dolor sit amet, altera fastidii voluptua sed cu, cu hinc adolescens sea, ei mel delicata molestiae constituam. Quot exerci meliore vel ex, eam affert propriae cu. Sea choro splendide similique ad.</p>
					...
					<div class="dropdown">
						<div class="title"><h1 class="x-light-grey accordion-trigger">PSC takes majority in financial software innovator Visionblue</h1>
							<p class="news__date">Monday 23rd July 2018</p>
							<ul class="contents" >
								<li>
									<p>Lorem ipsum dolor sit amet, altera fastidii voluptua sed cu, cu hinc adolescens sea, ei mel delicata molestiae constituam. Quot exerci meliore vel ex, eam affert propriae cu. Sea choro splendide similique ad.</p>
